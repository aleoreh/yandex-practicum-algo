...
- предыдущий указатель ставим на единицу меньше
- если значение на указателе меньше искомого
    - вычисляем дистанцию от указателя до предыдущего указателя
    - прыгаем указателем вперёд на половину дистанции (куда округлять?)
- если значение на указателе больше искомого
    - вычисляем дистанцию от предыдущего указателя до указателя
    - прыгаем указателем назад на половину дистанции (куда округлять?)
